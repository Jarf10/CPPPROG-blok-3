/*this syntax in printf: %6.2f%+6.2fi
 * represents in order of every character:
 * % to express that here comes a format
 * 6 for the spacing
 * x.2 to give the decimal value to be shown
 * f to express that the format is an floating point
 * + to show also by positive numbers the sign
 * 6 for the spacing
 * x.2 to give the decimal value to be shown
 * f to express that the format is an floating point
 * i is just the character 'i' to encourage that it is the imaginair value
 * /
